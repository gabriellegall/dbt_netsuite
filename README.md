...
- System variables must be created for SQL Server access locally : `setx SQLSERVER_HOST "XXX.XXX.XX.xx"; setx SQLSERVER_USER "sa"; setx SQLSERVER_PASSWORD "xxxxxxxxxx"`
